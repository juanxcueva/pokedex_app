...
import 'package:pokedex_app/app/domain/models/evolution_model.dart';
...
class PokemonModel {
    ...
    factory PokemonModel.fromMap(Map<String, dynamic> json) => PokemonModel(
        ...
        nextEvolution: json["next_evolution"] == null ? null : List<EvolutionModel>.from(json["next_evolution"].map((x) => EvolutionModel.fromMap(x))),
        prevEvolution: json["prev_evolution"] == null ? null : List<EvolutionModel>.from(json["prev_evolution"].map((x) => EvolutionModel.fromMap(x))),
    );
